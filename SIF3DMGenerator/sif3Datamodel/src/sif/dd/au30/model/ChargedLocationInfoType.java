 ...
 *         &lt;element name="ParentChargedLocationInfoRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
...
@XmlType(name = "ChargedLocationInfoType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "locationType",
    "siteCategory",
    "name",
    "description",
...
public class ChargedLocationInfoType {
    ...
    @XmlElement(name = "LocationType", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String locationType;
    @XmlElement(name = "SiteCategory", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    @XmlElementRef(name = "ParentChargedLocationInfoRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
