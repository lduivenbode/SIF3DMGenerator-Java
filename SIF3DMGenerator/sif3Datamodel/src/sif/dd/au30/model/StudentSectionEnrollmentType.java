...
@XmlType(name = "StudentSectionEnrollmentType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
...
public class StudentSectionEnrollmentType {
    ...
    @XmlElement(name = "SectionInfoRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    @XmlElementRef(name = "EntryDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
