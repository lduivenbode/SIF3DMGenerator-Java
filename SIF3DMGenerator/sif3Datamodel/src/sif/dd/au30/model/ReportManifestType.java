 ...
 *       &lt;sequence>
 *         &lt;element name="SIF_Version" type="{http://www.sifassociation.org/au/datamodel/1.4}VersionWithWildcardsType" minOccurs="0"/>
 ...
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                   &lt;sequence>
 *                     &lt;element ref="{http://www.sifassociation.org/au/datamodel/1.4}SIF_Query" maxOccurs="unbounded" minOccurs="0"/>
 *                   &lt;/sequence>
 *                 &lt;/restriction>
 *               &lt;/complexContent>
 *             &lt;/complexType>
 *           &lt;/element>
 *           &lt;element name="SIF_ExtendedQuery" type="{http://www.sifassociation.org/au/datamodel/1.4}SIF_ExtendedQueryDataModelType" minOccurs="0"/>
 *         &lt;/choice>
 ...
 *       &lt;attribute name="ReportAuthorityInfoRefId" use="required" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "ReportManifestType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "sifVersion",
    "sifMaxBufferSize",
    "receivingAuthority",
    "reportName",
...
public class ReportManifestType {
    ...
    @XmlElement(name = "SIF_Version", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String sifVersion;
    @XmlElement(name = "SIF_MaxBufferSize", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlSchemaType(name = "unsignedInt")
    protected Long sifMaxBufferSize;
    @XmlElementRef(name = "ReceivingAuthority", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ReportManifestType.ReceivingAuthority> receivingAuthority;
    @XmlElement(name = "ReportName", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    @XmlElementRef(name = "ReportingPeriod", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ReportManifestType.ReportingPeriod> reportingPeriod;
    @XmlElement(name = "ReportDefinitionSource", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected ReportManifestType.ReportDefinitionSource reportDefinitionSource;
    @XmlElementRef(name = "ReportFormatList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ReportManifestType.ReportFormatList> reportFormatList;
    @XmlElementRef(name = "SIF_QueryGroup", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ReportManifestType.SIFQueryGroup> sifQueryGroup;
    @XmlElementRef(name = "SIF_ExtendedQuery", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class ReportFormatList {
        ...
        @XmlElement(name = "ReportFormat", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class ReportingPeriod {
        ...
        @XmlElementRef(name = "BeginReportDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<XMLGregorianCalendar> beginReportDate;
        @XmlElementRef(name = "EndReportDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<XMLGregorianCalendar> endReportDate;
        @XmlElementRef(name = "BeginSubmitDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<XMLGregorianCalendar> beginSubmitDate;
        @XmlElementRef(name = "EndSubmitDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class SIFQueryGroup {
        ...
        @XmlElement(name = "SIF_Query", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
