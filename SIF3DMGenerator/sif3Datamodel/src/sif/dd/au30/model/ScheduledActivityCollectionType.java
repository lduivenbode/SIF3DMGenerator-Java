 ...
 *       &lt;sequence>
 *         &lt;element name="ScheduledActivity" type="{http://www.sifassociation.org/au/datamodel/1.4}ScheduledActivityType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ScheduledActivityCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "scheduledActivity"
})
public class ScheduledActivityCollectionType {

    @XmlElement(name = "ScheduledActivity", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
