 ...
 *       &lt;sequence>
 *         &lt;element name="LEAInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}LEAInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LEAInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "leaInfo"
})
public class LEAInfoCollectionType {

    @XmlElement(name = "LEAInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
