 ...
 *         &lt;element name="TargetAssessmentItemRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
...
@XmlType(name = "Sif3AssessmentItemAssociationType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "assessmentItemRefId",
...
public class Sif3AssessmentItemAssociationType {
    ...
    @XmlElement(name = "TargetAssessmentItemRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String targetAssessmentItemRefId;
    @XmlElement(name = "AssociationType", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
