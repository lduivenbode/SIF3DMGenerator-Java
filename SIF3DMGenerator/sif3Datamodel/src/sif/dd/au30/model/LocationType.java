...
@XmlType(name = "LocationType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "locationName",
    "locationRefId"
})
public class LocationType {

    @XmlElementRef(name = "LocationName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> locationName;
    @XmlElementRef(name = "LocationRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
