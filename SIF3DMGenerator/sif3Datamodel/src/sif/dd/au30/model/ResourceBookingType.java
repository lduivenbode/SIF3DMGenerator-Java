 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="ResourceLocalId" type="{http://www.sifassociation.org/au/datamodel/1.4}LocalIdType" minOccurs="0"/>
 *         &lt;element name="StartDateTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="FinishDateTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="FromPeriod" type="{http://www.sifassociation.org/au/datamodel/1.4}LocalIdType" minOccurs="0"/>
 *         &lt;element name="ToPeriod" type="{http://www.sifassociation.org/au/datamodel/1.4}LocalIdType" minOccurs="0"/>
 *         &lt;element name="Booker" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="Reason" type="{http://www.w3.org/2001/XMLSchema}normalizedString" minOccurs="0"/>
 *         &lt;element name="ScheduledActivityRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
...
@XmlType(name = "ResourceBookingType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "resourceRefId",
    "resourceLocalId",
    "startDateTime",
    "finishDateTime",
...
public class ResourceBookingType {
    ...
    @XmlElementRef(name = "ResourceRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ResourceBookingType.ResourceRefId> resourceRefId;
    @XmlElement(name = "ResourceLocalId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String resourceLocalId;
    @XmlElement(name = "StartDateTime", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar startDateTime;
    @XmlElement(name = "FinishDateTime", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar finishDateTime;
    @XmlElementRef(name = "FromPeriod", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fromPeriod;
    @XmlElementRef(name = "ToPeriod", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> toPeriod;
    @XmlElement(name = "Booker", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String booker;
    @XmlElementRef(name = "Reason", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> reason;
    @XmlElementRef(name = "ScheduledActivityRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> scheduledActivityRefId;
    @XmlElementRef(name = "KeepOld", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
