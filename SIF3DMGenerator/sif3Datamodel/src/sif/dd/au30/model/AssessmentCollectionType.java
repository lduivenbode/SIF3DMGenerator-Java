 ...
 *       &lt;sequence>
 *         &lt;element name="Assessment" type="{http://www.sifassociation.org/au/datamodel/1.4}AssessmentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AssessmentCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "assessment"
})
public class AssessmentCollectionType {

    @XmlElement(name = "Assessment", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
