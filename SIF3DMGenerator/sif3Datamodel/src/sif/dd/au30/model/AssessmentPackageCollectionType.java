 ...
 *       &lt;sequence>
 *         &lt;element name="AssessmentPackage" type="{http://www.sifassociation.org/au/datamodel/1.4}AssessmentPackageType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AssessmentPackageCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "assessmentPackage"
})
public class AssessmentPackageCollectionType {

    @XmlElement(name = "AssessmentPackage", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
