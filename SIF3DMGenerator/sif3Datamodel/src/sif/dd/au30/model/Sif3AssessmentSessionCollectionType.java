 ...
 *       &lt;sequence>
 *         &lt;element name="Sif3AssessmentSession" type="{http://www.sifassociation.org/au/datamodel/1.4}Sif3AssessmentSessionType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Sif3AssessmentSessionCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "sif3AssessmentSession"
})
public class Sif3AssessmentSessionCollectionType {

    @XmlElement(name = "Sif3AssessmentSession", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
