 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="AuthenticationSourceGlobalUID" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
...
@XmlType(name = "IdentityType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "sifRefId",
...
public class IdentityType {
    ...
    @XmlElement(name = "AuthenticationSource", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String authenticationSource;
    @XmlElementRef(name = "IdentityAssertions", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<IdentityType.IdentityAssertions> identityAssertions;
    @XmlElementRef(name = "PasswordList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<IdentityType.PasswordList> passwordList;
    @XmlElementRef(name = "AuthenticationSourceGlobalUID", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class IdentityAssertions {
        ...
        @XmlElement(name = "IdentityAssertion", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class PasswordList {
        ...
        @XmlElement(name = "Password", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
