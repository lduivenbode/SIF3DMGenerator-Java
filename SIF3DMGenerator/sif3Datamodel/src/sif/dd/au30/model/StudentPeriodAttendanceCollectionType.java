 ...
 *       &lt;sequence>
 *         &lt;element name="StudentPeriodAttendance" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentPeriodAttendanceType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentPeriodAttendanceCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentPeriodAttendance"
})
public class StudentPeriodAttendanceCollectionType {

    @XmlElement(name = "StudentPeriodAttendance", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
