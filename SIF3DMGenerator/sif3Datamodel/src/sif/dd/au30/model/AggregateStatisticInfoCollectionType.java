 ...
 *       &lt;sequence>
 *         &lt;element name="AggregateStatisticInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}AggregateStatisticInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AggregateStatisticInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "aggregateStatisticInfo"
})
public class AggregateStatisticInfoCollectionType {

    @XmlElement(name = "AggregateStatisticInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
