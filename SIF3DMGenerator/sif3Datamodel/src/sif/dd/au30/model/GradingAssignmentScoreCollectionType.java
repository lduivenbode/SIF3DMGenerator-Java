 ...
 *       &lt;sequence>
 *         &lt;element name="GradingAssignmentScore" type="{http://www.sifassociation.org/au/datamodel/1.4}GradingAssignmentScoreType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GradingAssignmentScoreCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "gradingAssignmentScore"
})
public class GradingAssignmentScoreCollectionType {

    @XmlElement(name = "GradingAssignmentScore", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
