 ...
 *       &lt;sequence>
 *         &lt;element name="TimeTableSubject" type="{http://www.sifassociation.org/au/datamodel/1.4}TimeTableSubjectType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TimeTableSubjectCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "timeTableSubject"
})
public class TimeTableSubjectCollectionType {

    @XmlElement(name = "TimeTableSubject", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
