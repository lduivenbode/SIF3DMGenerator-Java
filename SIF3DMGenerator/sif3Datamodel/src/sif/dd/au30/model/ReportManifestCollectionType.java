 ...
 *       &lt;sequence>
 *         &lt;element name="ReportManifest" type="{http://www.sifassociation.org/au/datamodel/1.4}ReportManifestType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReportManifestCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "reportManifest"
})
public class ReportManifestCollectionType {

    @XmlElement(name = "ReportManifest", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
