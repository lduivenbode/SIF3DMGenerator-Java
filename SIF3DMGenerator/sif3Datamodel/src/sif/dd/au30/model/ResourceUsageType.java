 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Code" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsResourceUsageContentTypeType" minOccurs="0"/>
 ...
 *                             &lt;element name="CurrentCost" type="{http://www.sifassociation.org/au/datamodel/1.4}MonetaryAmountType" minOccurs="0"/>
...
@XmlType(name = "ResourceUsageType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "schoolInfoRefId",
...
public class ResourceUsageType {
    ...
    @XmlElement(name = "ResourceUsageContentType", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected ResourceUsageType.ResourceUsageContentType resourceUsageContentType;
    @XmlElement(name = "ResourceReportColumnList", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected ResourceUsageType.ResourceReportColumnList resourceReportColumnList;
    @XmlElement(name = "ResourceReportLineList", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class ResourceReportColumnList {
        ...
        @XmlElement(name = "ResourceReportColumn", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class ResourceReportColumn {
            ...
            @XmlElement(name = "ColumnName", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
            @XmlSchemaType(name = "normalizedString")
            protected String columnName;
            @XmlElementRef(name = "ColumnDescription", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            protected JAXBElement<String> columnDescription;
            @XmlElementRef(name = "ColumnDelimiter", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class ResourceReportLineList {
        ...
        @XmlElement(name = "ResourceReportLine", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class ResourceReportLine {
            ...
            @XmlElement(name = "CurrentCost", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            protected MonetaryAmountType currentCost;
            @XmlElement(name = "ReportRow", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
            @XmlSchemaType(name = "normalizedString")
    ...
    public static class ResourceUsageContentType {
        ...
        @XmlElementRef(name = "LocalDescription", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
