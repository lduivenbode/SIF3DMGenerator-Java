 ...
 *       &lt;sequence>
 *         &lt;element name="SectionInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}SectionInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SectionInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "sectionInfo"
})
public class SectionInfoCollectionType {

    @XmlElement(name = "SectionInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
