 ...
 *       &lt;sequence>
 *         &lt;element name="TimeTableCell" type="{http://www.sifassociation.org/au/datamodel/1.4}TimeTableCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TimeTableCellCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "timeTableCell"
})
public class TimeTableCellCollectionType {

    @XmlElement(name = "TimeTableCell", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
