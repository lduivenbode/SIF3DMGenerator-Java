 ...
 *       &lt;sequence>
 *         &lt;element name="TermInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}TermInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TermInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "termInfo"
})
public class TermInfoCollectionType {

    @XmlElement(name = "TermInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
