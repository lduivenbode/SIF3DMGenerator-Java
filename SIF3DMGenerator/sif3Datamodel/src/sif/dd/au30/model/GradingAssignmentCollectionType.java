 ...
 *       &lt;sequence>
 *         &lt;element name="GradingAssignment" type="{http://www.sifassociation.org/au/datamodel/1.4}GradingAssignmentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GradingAssignmentCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "gradingAssignment"
})
public class GradingAssignmentCollectionType {

    @XmlElement(name = "GradingAssignment", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
