...
@XmlType(name = "SIF_ExtendedQueryDataModelType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
...
public class SIFExtendedQueryDataModelType {
    ...
    @XmlElementRef(name = "SIF_DestinationProvider", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sifDestinationProvider;
    @XmlElement(name = "SIF_Select", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected SIFExtendedQueryDataModelType.SIFSelect sifSelect;
    @XmlElement(name = "SIF_From", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected SIFExtendedQueryDataModelType.SIFFrom sifFrom;
    @XmlElementRef(name = "SIF_Where", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<SIFExtendedQueryDataModelType.SIFWhere> sifWhere;
    @XmlElementRef(name = "SIF_OrderBy", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class SIFFrom {
        ...
        public static class SIFJoin {
            ...
            @XmlElement(name = "SIF_JoinOn", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            ...
            public static class SIFJoinOn {
                ...
                @XmlElement(name = "SIF_LeftElement", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
                protected SIFExtendedQueryDataModelType.SIFFrom.SIFJoin.SIFJoinOn.SIFLeftElement sifLeftElement;
                @XmlElement(name = "SIF_RightElement", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class SIFOrderBy {
        ...
        @XmlElement(name = "SIF_Element", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class SIFWhere {
        ...
        @XmlElement(name = "SIF_ConditionGroup", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class SIFConditionGroup {
            ...
            @XmlElement(name = "SIF_Conditions", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            ...
            public static class SIFConditions {
                ...
                @XmlElement(name = "SIF_Condition", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
                ...
                public static class SIFCondition {
                    ...
                    @XmlElement(name = "SIF_Operator", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
                    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
                    protected String sifOperator;
                    @XmlElement(name = "SIF_Value", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
