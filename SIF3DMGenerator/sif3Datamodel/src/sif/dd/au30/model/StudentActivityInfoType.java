 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Code" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsActivityInvolvementCodeType" minOccurs="0"/>
 ...
 *         &lt;element name="CurricularStatus" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsActivityTypeType" minOccurs="0"/>
...
@XmlType(name = "StudentActivityInfoType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "title",
    "description",
    "studentActivityType",
...
public class StudentActivityInfoType {
    ...
    @XmlElement(name = "StudentActivityType", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected StudentActivityInfoType.StudentActivityType studentActivityType;
    @XmlElementRef(name = "StudentActivityLevel", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "CurricularStatus", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
