 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="SubjectArea" type="{http://www.sifassociation.org/au/datamodel/1.4}SubjectAreaType" minOccurs="0"/>
 ...
 *                     &lt;complexType>
 *                       &lt;simpleContent>
 *                         &lt;extension base="&lt;http://www.sifassociation.org/au/datamodel/1.4>XSUnsignedIntOrEmpty">
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="AssessmentRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="LearningResourceRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "ActivityType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "title",
    "preamble",
...
public class ActivityType {
    ...
    @XmlElementRef(name = "Preamble", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preamble;
    @XmlElementRef(name = "TechnicalRequirements", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.TechnicalRequirements> technicalRequirements;
    @XmlElementRef(name = "SoftwareRequirementList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.SoftwareRequirementList> softwareRequirementList;
    @XmlElementRef(name = "EssentialMaterials", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.EssentialMaterials> essentialMaterials;
    @XmlElementRef(name = "LearningObjectives", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.LearningObjectives> learningObjectives;
    @XmlElementRef(name = "LearningStandards", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.LearningStandards> learningStandards;
    @XmlElementRef(name = "SubjectArea", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<SubjectAreaType> subjectArea;
    @XmlElementRef(name = "Prerequisites", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.Prerequisites> prerequisites;
    @XmlElementRef(name = "Students", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.Students> students;
    @XmlElementRef(name = "SourceObjects", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.SourceObjects> sourceObjects;
    @XmlElementRef(name = "Points", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> points;
    @XmlElement(name = "ActivityTime", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected ActivityType.ActivityTime activityTime;
    @XmlElementRef(name = "AssessmentRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> assessmentRefId;
    @XmlElementRef(name = "MaxAttemptsAllowed", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> maxAttemptsAllowed;
    @XmlElementRef(name = "ActivityWeight", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> activityWeight;
    @XmlElementRef(name = "Evaluation", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ActivityType.Evaluation> evaluation;
    @XmlElementRef(name = "LearningResources", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class ActivityTime {
        ...
        @XmlElementRef(name = "Duration", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<ActivityType.ActivityTime.Duration> duration;
        @XmlElementRef(name = "StartDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<XMLGregorianCalendar> startDate;
        @XmlElementRef(name = "FinishDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<XMLGregorianCalendar> finishDate;
        @XmlElementRef(name = "DueDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class EssentialMaterials {
        ...
        @XmlElement(name = "EssentialMaterial", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class LearningObjectives {
        ...
        @XmlElement(name = "LearningObjective", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class LearningResources {
        ...
        @XmlElement(name = "LearningResourceRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    public static class Prerequisites {
        ...
        @XmlElement(name = "Prerequisite", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class SoftwareRequirementList {
        ...
        @XmlElement(name = "SoftwareRequirement", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class SoftwareRequirement {
            ...
            @XmlElement(name = "SoftwareTitle", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            protected String softwareTitle;
            @XmlElementRef(name = "Version", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            protected JAXBElement<String> version;
            @XmlElementRef(name = "Vendor", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            protected JAXBElement<String> vendor;
            @XmlElementRef(name = "OS", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class SourceObjects {
        ...
        @XmlElement(name = "SourceObject", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class TechnicalRequirements {
        ...
        @XmlElementRef(name = "TechnicalRequirement", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
