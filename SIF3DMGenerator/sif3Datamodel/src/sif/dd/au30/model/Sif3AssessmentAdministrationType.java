 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="AdministrationAssessment" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "Sif3AssessmentAdministrationType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "administrationName",
    "administrationCode",
    "startDateTime",
    "finishDateTime",
...
public class Sif3AssessmentAdministrationType {
    ...
    @XmlElementRef(name = "AdministrationCode", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "AdministrationAssessments", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Sif3AssessmentAdministrationType.AdministrationAssessments> administrationAssessments;
    @XmlElementRef(name = "Organizations", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class AdministrationAssessments {
        ...
        @XmlElement(name = "AdministrationAssessment", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
