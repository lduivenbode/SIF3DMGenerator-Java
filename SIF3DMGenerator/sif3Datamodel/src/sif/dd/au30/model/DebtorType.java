...
/**
 * 
 *         This object contains is used to capture general information about debtors.
 * 
...
@XmlType(name = "DebtorType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "billedEntity",
    "addressList",
    "billingName",
    "billingNote",
...
public class DebtorType {
    ...
    @XmlElement(name = "BilledEntity", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    @XmlElementRef(name = "BillingName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> billingName;
    @XmlElementRef(name = "BillingNote", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> billingNote;
    @XmlElementRef(name = "Discount", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
