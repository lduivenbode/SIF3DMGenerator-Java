...
/**
 * This object contains is used to adjust balances between accounts. It is typically used to correct chart of account coding errors (e.g. created invoices for parents against the maths chart of account code when it should have been English).
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="DebitFinancialAccountRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="CreditFinancialAccountRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
...
@XmlType(name = "JournalType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
...
public class JournalType {
    ...
    @XmlElement(name = "DebitFinancialAccountRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String debitFinancialAccountRefId;
    @XmlElement(name = "CreditFinancialAccountRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String creditFinancialAccountRefId;
    @XmlElementRef(name = "OriginatingTransactionRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "GSTCodeOriginal", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> gstCodeOriginal;
    @XmlElementRef(name = "GSTCodeReplacement", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> gstCodeReplacement;
    @XmlElementRef(name = "Note", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> note;
    @XmlElementRef(name = "CreatedDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> createdDate;
    @XmlElementRef(name = "ApprovedDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> approvedDate;
    @XmlElementRef(name = "CreatedBy", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> createdBy;
    @XmlElementRef(name = "ApprovedBy", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> approvedBy;
    @XmlElementRef(name = "FinancialClassificationRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> financialClassificationRefId;
     ...
     *     
     */
    public JAXBElement<String> getFinancialClassificationRefId() {
     ...
     *     
     */
    public void setFinancialClassificationRefId(JAXBElement<String> value) {
