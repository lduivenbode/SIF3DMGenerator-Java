 ...
 *       &lt;sequence>
 *         &lt;element name="RoomInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}RoomInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RoomInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "roomInfo"
})
public class RoomInfoCollectionType {

    @XmlElement(name = "RoomInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
