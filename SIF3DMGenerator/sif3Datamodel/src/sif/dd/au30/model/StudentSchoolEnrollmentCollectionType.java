 ...
 *       &lt;sequence>
 *         &lt;element name="StudentSchoolEnrollment" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentSchoolEnrollmentType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentSchoolEnrollmentCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentSchoolEnrollment"
})
public class StudentSchoolEnrollmentCollectionType {

    @XmlElement(name = "StudentSchoolEnrollment", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
