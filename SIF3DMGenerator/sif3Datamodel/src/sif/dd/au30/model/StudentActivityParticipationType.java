...
@XmlType(name = "StudentActivityParticipationType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
...
public class StudentActivityParticipationType {
    ...
    @XmlElement(name = "StudentActivityInfoRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    @XmlElementRef(name = "ParticipationComment", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Role", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> role;
    @XmlElementRef(name = "RecognitionList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class RecognitionList {
        ...
        @XmlElement(name = "Recognition", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
