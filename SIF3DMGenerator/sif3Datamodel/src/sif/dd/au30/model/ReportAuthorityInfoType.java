...
@XmlType(name = "ReportAuthorityInfoType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "authorityName",
    "authorityId",
    "authorityDepartment",
    "authorityLevel",
...
public class ReportAuthorityInfoType {
    ...
    @XmlElement(name = "AuthorityName", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String authorityName;
    @XmlElement(name = "AuthorityId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String authorityId;
    @XmlElementRef(name = "AuthorityDepartment", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> authorityDepartment;
    @XmlElement(name = "AuthorityLevel", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
