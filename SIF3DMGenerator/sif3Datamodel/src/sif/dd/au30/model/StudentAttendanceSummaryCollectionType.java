 ...
 *       &lt;sequence>
 *         &lt;element name="StudentAttendanceSummary" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentAttendanceSummaryType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentAttendanceSummaryCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentAttendanceSummary"
})
public class StudentAttendanceSummaryCollectionType {

    @XmlElement(name = "StudentAttendanceSummary", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
