 ...
 *         &lt;element name="RelativeDuration" minOccurs="0">
 *           &lt;simpleType>
 ...
 *         &lt;element name="TermSpan" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsSessionTypeType" minOccurs="0"/>
 *         &lt;element name="MarkingTerm" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
 *         &lt;element name="SchedulingTerm" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
 *         &lt;element name="AttendanceTerm" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
...
@XmlType(name = "TermInfoType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "schoolInfoRefId",
    "schoolYear",
    "startDate",
    "endDate",
...
public class TermInfoType {
    ...
    @XmlElement(name = "StartDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar startDate;
    @XmlElement(name = "EndDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlSchemaType(name = "date")
    ...
    @XmlElementRef(name = "RelativeDuration", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> relativeDuration;
    @XmlElementRef(name = "TermCode", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> termCode;
    @XmlElementRef(name = "Track", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> track;
    @XmlElementRef(name = "TermSpan", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> termSpan;
    @XmlElementRef(name = "MarkingTerm", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> markingTerm;
    @XmlElementRef(name = "SchedulingTerm", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> schedulingTerm;
    @XmlElementRef(name = "AttendanceTerm", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> attendanceTerm;
     ...
     *     
     */
    public JAXBElement<BigDecimal> getRelativeDuration() {
     ...
     *     
     */
    public void setRelativeDuration(JAXBElement<BigDecimal> value) {
     ...
     *     
     */
    public JAXBElement<AUCodeSetsYesOrNoCategoryType> getMarkingTerm() {
        return markingTerm;
    }
     ...
     *     
     */
    public void setMarkingTerm(JAXBElement<AUCodeSetsYesOrNoCategoryType> value) {
     ...
     *     
     */
    public JAXBElement<AUCodeSetsYesOrNoCategoryType> getSchedulingTerm() {
     ...
     *     
     */
    public void setSchedulingTerm(JAXBElement<AUCodeSetsYesOrNoCategoryType> value) {
     ...
     *     
     */
    public JAXBElement<AUCodeSetsYesOrNoCategoryType> getAttendanceTerm() {
     ...
     *     
     */
    public void setAttendanceTerm(JAXBElement<AUCodeSetsYesOrNoCategoryType> value) {
