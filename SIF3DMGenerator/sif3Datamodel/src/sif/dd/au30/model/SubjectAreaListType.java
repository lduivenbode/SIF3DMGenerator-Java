 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.sifassociation.org/au/datamodel/1.4}SubjectArea" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SubjectAreaListType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "subjectArea"
})
public class SubjectAreaListType {

    @XmlElement(name = "SubjectArea", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
