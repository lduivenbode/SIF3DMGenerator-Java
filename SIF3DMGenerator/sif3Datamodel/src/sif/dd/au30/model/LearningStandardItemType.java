 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element ref="{http://www.sifassociation.org/au/datamodel/1.4}Country" minOccurs="0"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element ref="{http://www.sifassociation.org/au/datamodel/1.4}YearLevels" minOccurs="0"/>
 *         &lt;element name="ACStrandSubjectArea" type="{http://www.sifassociation.org/au/datamodel/1.4}ACStrandSubjectAreaType" minOccurs="0"/>
 ...
 *                   &lt;element ref="{http://www.sifassociation.org/au/datamodel/1.4}ACStrandSubjectArea" minOccurs="0"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="LearningStandardDocumentRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 ...
 *                             &lt;simpleType>
 *                               &lt;union memberTypes=" {http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsLearningStandardItemRelationshipTypesType {http://www.w3.org/2001/XMLSchema}token">
 *                               &lt;/union>
 *                             &lt;/simpleType>
 *                           &lt;/attribute>
 *                         &lt;/extension>
...
@XmlType(name = "LearningStandardItemType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "resources",
    "standardSettingBody",
...
public class LearningStandardItemType {
    ...
    @XmlElementRef(name = "Resources", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardItemType.Resources> resources;
    @XmlElementRef(name = "StandardSettingBody", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardItemType.StandardSettingBody> standardSettingBody;
    @XmlElement(name = "StandardHierarchyLevel", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected LearningStandardItemType.StandardHierarchyLevel standardHierarchyLevel;
    @XmlElementRef(name = "PredecessorItems", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardItemType.PredecessorItems> predecessorItems;
    @XmlElementRef(name = "StatementCodes", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardItemType.StatementCodes> statementCodes;
    @XmlElementRef(name = "Statements", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardItemType.Statements> statements;
    @XmlElement(name = "YearLevels", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected YearLevelsType yearLevels;
    @XmlElementRef(name = "ACStrandSubjectArea", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<ACStrandSubjectAreaType> acStrandSubjectArea;
    @XmlElementRef(name = "StandardIdentifier", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardItemType.StandardIdentifier> standardIdentifier;
    @XmlElement(name = "LearningStandardDocumentRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String learningStandardDocumentRefId;
    @XmlElementRef(name = "RelatedLearningStandardItems", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardItemType.RelatedLearningStandardItems> relatedLearningStandardItems;
    @XmlElementRef(name = "Level4", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> level4;
    @XmlElementRef(name = "Level5", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class StandardIdentifier {
        ...
        @XmlElement(name = "YearCreated", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        @XmlElement(name = "StandardNumber", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
        @XmlSchemaType(name = "normalizedString")
        protected String standardNumber;
        @XmlElement(name = "YearLevels", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        protected YearLevelsType yearLevels;
        @XmlElementRef(name = "Benchmark", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "IndicatorNumber", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<String> indicatorNumber;
        @XmlElementRef(name = "AlternateIdentificationCodes", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        ...
        public static class AlternateIdentificationCodes {
            ...
            @XmlElement(name = "AlternateIdentificationCode", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
            @XmlSchemaType(name = "normalizedString")
    ...
    public static class StandardSettingBody {
        ...
        @XmlElement(name = "Country", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
        ...
        @XmlElementRef(name = "SettingBodyName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class StatementCodes {
        ...
        @XmlElement(name = "StatementCode", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    public static class Statements {
        ...
        @XmlElement(name = "Statement", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
