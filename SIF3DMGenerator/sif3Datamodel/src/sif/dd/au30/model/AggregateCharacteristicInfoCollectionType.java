 ...
 *       &lt;sequence>
 *         &lt;element name="AggregateCharacteristicInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}AggregateCharacteristicInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AggregateCharacteristicInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "aggregateCharacteristicInfo"
})
public class AggregateCharacteristicInfoCollectionType {

    @XmlElement(name = "AggregateCharacteristicInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
