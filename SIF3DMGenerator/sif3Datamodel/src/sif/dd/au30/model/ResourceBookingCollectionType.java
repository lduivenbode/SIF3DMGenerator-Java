 ...
 *       &lt;sequence>
 *         &lt;element name="ResourceBooking" type="{http://www.sifassociation.org/au/datamodel/1.4}ResourceBookingType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ResourceBookingCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "resourceBooking"
})
public class ResourceBookingCollectionType {

    @XmlElement(name = "ResourceBooking", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
