 ...
 *       &lt;sequence>
 *         &lt;element name="EquipmentInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}EquipmentInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "EquipmentInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "equipmentInfo"
})
public class EquipmentInfoCollectionType {

    @XmlElement(name = "EquipmentInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
