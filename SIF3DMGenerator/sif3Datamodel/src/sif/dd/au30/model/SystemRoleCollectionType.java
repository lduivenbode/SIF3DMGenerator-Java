 ...
 *       &lt;sequence>
 *         &lt;element name="SystemRole" type="{http://www.sifassociation.org/au/datamodel/1.4}SystemRoleType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SystemRoleCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "systemRole"
})
public class SystemRoleCollectionType {

    @XmlElement(name = "SystemRole", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
