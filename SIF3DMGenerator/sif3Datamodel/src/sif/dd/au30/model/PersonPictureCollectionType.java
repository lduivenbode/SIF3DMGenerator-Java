 ...
 *       &lt;sequence>
 *         &lt;element name="PersonPicture" type="{http://www.sifassociation.org/au/datamodel/1.4}PersonPictureType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PersonPictureCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "personPicture"
})
public class PersonPictureCollectionType {

    @XmlElement(name = "PersonPicture", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
