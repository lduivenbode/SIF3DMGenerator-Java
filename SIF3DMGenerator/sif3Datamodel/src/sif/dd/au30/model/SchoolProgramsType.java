...
@XmlType(name = "SchoolProgramsType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "schoolInfoRefId",
    "schoolYear",
    "schoolProgramList",
    "sifMetadata",
...
public class SchoolProgramsType {
    ...
    @XmlElementRef(name = "SchoolProgramList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class SchoolProgramList {
        ...
        @XmlElement(name = "Program", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class Program {
            ...
            @XmlElementRef(name = "Category", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
