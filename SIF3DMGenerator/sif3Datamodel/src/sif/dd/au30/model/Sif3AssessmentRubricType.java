 ...
 *                             &lt;element name="ScoreCodeDefinition" type="{http://www.sifassociation.org/au/datamodel/1.4}AbstractContentElementType" minOccurs="0"/>
 ...
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 *                                       &lt;element name="ScoreDescription" type="{http://www.sifassociation.org/au/datamodel/1.4}AbstractContentElementType" maxOccurs="unbounded" minOccurs="0"/>
 *                                     &lt;/sequence>
 *                                   &lt;/restriction>
 *                                 &lt;/complexContent>
 *                               &lt;/complexType>
 ...
 *                                                 &lt;element name="Comment" type="{http://www.sifassociation.org/au/datamodel/1.4}AbstractContentElementType" minOccurs="0"/>
 *                                               &lt;/sequence>
 *                                             &lt;/restriction>
 *                                           &lt;/complexContent>
 *                                         &lt;/complexType>
...
@XmlType(name = "Sif3AssessmentRubricType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "rubricVersion",
    "rubricPublishDate",
    "rubricIdentifiers",
    "rubricName",
...
public class Sif3AssessmentRubricType {
    ...
    @XmlElementRef(name = "RubricVersion", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> rubricVersion;
    @XmlElementRef(name = "RubricPublishDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Calendar> rubricPublishDate;
    @XmlElementRef(name = "RubricIdentifiers", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Sif3AssessmentRubricType.RubricIdentifiers> rubricIdentifiers;
    @XmlElement(name = "RubricName", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String rubricName;
    @XmlElementRef(name = "ScoringGuideReference", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> scoringGuideReference;
    @XmlElementRef(name = "Scores", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class RubricIdentifiers {
        ...
        @XmlElement(name = "RubricIdentifier", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class Scores {
        ...
        @XmlElement(name = "Score", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class Score {
            ...
            @XmlElementRef(name = "ScoreCode", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            protected JAXBElement<String> scoreCode;
            @XmlElementRef(name = "ScoreCodeDefinition", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            ...
            @XmlElementRef(name = "ScoreDescriptions", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            protected JAXBElement<Sif3AssessmentRubricType.Scores.Score.ScoreDescriptions> scoreDescriptions;
            @XmlElementRef(name = "ScoreComments", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            ...
            public static class ScoreComments {
                ...
                @XmlElement(name = "ScoreComment", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
            ...
            public static class ScoreDescriptions {
                ...
                @XmlElement(name = "ScoreDescription", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
