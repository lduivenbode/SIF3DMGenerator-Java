 ...
 *       &lt;sequence>
 *         &lt;element name="VendorInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}VendorInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "VendorInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "vendorInfo"
})
public class VendorInfoCollectionType {

    @XmlElement(name = "VendorInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
