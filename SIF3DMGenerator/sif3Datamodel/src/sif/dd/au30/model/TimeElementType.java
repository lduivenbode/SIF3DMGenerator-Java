...
@XmlType(name = "TimeElementType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "type",
    "code",
    "name",
    "value",
...
public class TimeElementType {
    ...
    @XmlElementRef(name = "SpanGaps", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<TimeElementType.SpanGaps> spanGaps;
    @XmlElement(name = "IsCurrent", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class SpanGaps {
        ...
        @XmlElement(name = "SpanGap", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
