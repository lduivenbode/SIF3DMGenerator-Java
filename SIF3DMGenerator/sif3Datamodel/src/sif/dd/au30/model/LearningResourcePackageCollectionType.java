 ...
 *       &lt;sequence>
 *         &lt;element name="LearningResourcePackage" type="{http://www.sifassociation.org/au/datamodel/1.4}LearningResourcePackageType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LearningResourcePackageCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "learningResourcePackage"
})
public class LearningResourcePackageCollectionType {

    @XmlElement(name = "LearningResourcePackage", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
