...
@XmlType(name = "SystemRoleType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "sifRefId",
    "systemContextList",
    "sifMetadata",
    "sifExtendedElements"
...
public class SystemRoleType {
    ...
    @XmlElement(name = "SIF_RefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected SystemRoleType.SIFRefId sifRefId;
    @XmlElement(name = "SystemContextList", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    public static class SystemContextList {
        ...
        @XmlElement(name = "SystemContext", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class SystemContext {
            ...
            @XmlElementRef(name = "RoleList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            ...
            public static class RoleList {
                ...
                @XmlElement(name = "Role", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
                ...
                public static class Role {
                    ...
                    @XmlElementRef(name = "RoleScopeList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
                    ...
                    public static class RoleScopeList {
                        ...
                        @XmlElement(name = "RoleScope", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
                        ...
                        public static class RoleScope {
                            ...
                            @XmlElementRef(name = "RoleScopeName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
                            protected JAXBElement<String> roleScopeName;
                            @XmlElementRef(name = "RoleScopeRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
