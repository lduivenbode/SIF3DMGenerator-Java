 ...
 *         &lt;element name="PrimaryAssignment" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Code" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsStaffActivityType" minOccurs="0"/>
 ...
 *         &lt;element name="CasualReliefTeacher" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
...
@XmlType(name = "StaffAssignmentType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "schoolInfoRefId",
    "schoolYear",
    "staffPersonalRefId",
    "description",
...
public class StaffAssignmentType {
    ...
    @XmlElement(name = "PrimaryAssignment", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected AUCodeSetsYesOrNoCategoryType primaryAssignment;
    @XmlElementRef(name = "JobStartDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> jobStartDate;
    @XmlElementRef(name = "JobEndDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> jobEndDate;
    @XmlElementRef(name = "JobFTE", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> jobFTE;
    @XmlElementRef(name = "JobFunction", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> jobFunction;
    @XmlElementRef(name = "StaffSubjectList", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<StaffAssignmentType.StaffSubjectList> staffSubjectList;
    @XmlElementRef(name = "StaffActivity", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "CasualReliefTeacher", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class StaffSubjectList {
        ...
        @XmlElement(name = "StaffSubject", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class StaffSubject {
            ...
            @XmlElement(name = "PreferenceNumber", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
