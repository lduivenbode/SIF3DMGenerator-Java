...
@XmlType(name = "AssessmentFormType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "assessmentRefId",
    "assessmentType",
    "formName",
    "formNumbers",
...
public class AssessmentFormType {
    ...
    @XmlElementRef(name = "FormNumbers", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
