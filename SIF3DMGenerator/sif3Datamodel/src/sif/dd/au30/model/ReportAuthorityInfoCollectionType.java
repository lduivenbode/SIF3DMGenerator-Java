 ...
 *       &lt;sequence>
 *         &lt;element name="ReportAuthorityInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}ReportAuthorityInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReportAuthorityInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "reportAuthorityInfo"
})
public class ReportAuthorityInfoCollectionType {

    @XmlElement(name = "ReportAuthorityInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
