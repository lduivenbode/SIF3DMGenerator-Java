 ...
 *       &lt;sequence>
 *         &lt;element name="ResourceUsage" type="{http://www.sifassociation.org/au/datamodel/1.4}ResourceUsageType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ResourceUsageCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "resourceUsage"
})
public class ResourceUsageCollectionType {

    @XmlElement(name = "ResourceUsage", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
