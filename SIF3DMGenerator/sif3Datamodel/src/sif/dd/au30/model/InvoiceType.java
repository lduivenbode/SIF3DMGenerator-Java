 ...
 *         &lt;element name="RelatedPurchaseOrderRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="Voluntary" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
...
@XmlType(name = "InvoiceType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "invoicedEntity",
    "billingDate",
...
public class InvoiceType {
    ...
    @XmlElement(name = "InvoicedEntity", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected InvoiceType.InvoicedEntity invoicedEntity;
    @XmlElement(name = "BillingDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar billingDate;
    @XmlElement(name = "TransactionDescription", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String transactionDescription;
    @XmlElement(name = "BilledAmount", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected InvoiceType.BilledAmount billedAmount;
    @XmlElement(name = "Ledger", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    @XmlElementRef(name = "TaxType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ItemDetail", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "RelatedPurchaseOrderRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> relatedPurchaseOrderRefId;
    @XmlElementRef(name = "Voluntary", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    /**
     * Amount to be billed. Can be credit (e.g. for family credit notes, reimbursements, rebates).
     * 
