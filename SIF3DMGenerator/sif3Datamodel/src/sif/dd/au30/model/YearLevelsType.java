 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.sifassociation.org/au/datamodel/1.4}YearLevel" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "YearLevelsType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "yearLevel"
})
public class YearLevelsType {

    @XmlElement(name = "YearLevel", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
