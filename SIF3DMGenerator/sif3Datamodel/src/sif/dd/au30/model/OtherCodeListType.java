 ...
 * 
 * <pre>
 * &lt;complexType name="OtherCodeListType">
 *   &lt;complexContent>
 ...
 *                 &lt;attribute name="Codeset" use="required">
 *                   &lt;simpleType>
...
@XmlType(name = "OtherCodeListType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "otherCode"
})
public class OtherCodeListType {

    @XmlElement(name = "OtherCode", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
     ...
     * {@link OtherCodeListType.OtherCode }
     * 
     * 
     */
    public List<OtherCodeListType.OtherCode> getOtherCode() {
        if (otherCode == null) {
            otherCode = new ArrayList<OtherCodeListType.OtherCode>();
        }
