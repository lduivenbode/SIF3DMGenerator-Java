 ...
 *       &lt;sequence>
 *         &lt;element name="AggregateStatisticFact" type="{http://www.sifassociation.org/au/datamodel/1.4}AggregateStatisticFactType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AggregateStatisticFactCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "aggregateStatisticFact"
})
public class AggregateStatisticFactCollectionType {

    @XmlElement(name = "AggregateStatisticFact", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
