 ...
 *         &lt;element name="Location" type="{http://www.sifassociation.org/au/datamodel/1.4}LocationType" minOccurs="0"/>
...
@XmlType(name = "AggregateStatisticInfoType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "statisticName",
    "calculationRule",
    "approvalDate",
    "expirationDate",
...
public class AggregateStatisticInfoType {
    ...
    @XmlElement(name = "StatisticName", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String statisticName;
    @XmlElementRef(name = "CalculationRule", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<AggregateStatisticInfoType.CalculationRule> calculationRule;
    @XmlElementRef(name = "ApprovalDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> approvalDate;
    @XmlElementRef(name = "ExpirationDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> expirationDate;
    @XmlElementRef(name = "ExclusionRules", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "EffectiveDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> effectiveDate;
    @XmlElementRef(name = "DiscontinueDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Measure", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class ExclusionRules {
        ...
        @XmlElement(name = "ExclusionRule", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
