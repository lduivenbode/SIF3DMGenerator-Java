 ...
 *       &lt;sequence>
 *         &lt;element name="SessionInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}SessionInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SessionInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "sessionInfo"
})
public class SessionInfoCollectionType {

    @XmlElement(name = "SessionInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
