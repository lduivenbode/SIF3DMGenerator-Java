 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="Stimulus" type="{http://www.sifassociation.org/au/datamodel/1.4}AbstractContentElementType" minOccurs="0"/>
...
@XmlType(name = "AssessmentItemType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "assessmentFormRefId",
    "responseType",
    "itemLabel",
    "itemName",
...
public class AssessmentItemType {
    ...
    @XmlElement(name = "ResponseType", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String responseType;
    @XmlElement(name = "ItemLabel", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    @XmlElementRef(name = "Stimulus", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PerformanceLevels", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class PerformanceLevels {
        ...
        @XmlElement(name = "PerformanceLevel", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        ...
        public static class PerformanceLevel {
            ...
            @XmlElementRef(name = "CutScores", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
            ...
            public static class CutScores {
                ...
                @XmlElementRef(name = "LowerCut", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
                protected JAXBElement<String> lowerCut;
                @XmlElementRef(name = "UpperCut", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
