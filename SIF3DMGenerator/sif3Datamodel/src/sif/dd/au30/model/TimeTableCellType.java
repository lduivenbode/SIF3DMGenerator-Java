 ...
 *         &lt;element name="RoomInfoRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="StaffPersonalRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="TimeTableLocalId" type="{http://www.sifassociation.org/au/datamodel/1.4}LocalIdType" minOccurs="0"/>
 *         &lt;element name="SubjectLocalId" type="{http://www.sifassociation.org/au/datamodel/1.4}LocalIdType" minOccurs="0"/>
 *         &lt;element name="TeachingGroupLocalId" type="{http://www.sifassociation.org/au/datamodel/1.4}LocalIdType" minOccurs="0"/>
...
@XmlType(name = "TimeTableCellType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "timeTableRefId",
...
public class TimeTableCellType {
    ...
    @XmlElement(name = "TimeTableRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String timeTableRefId;
    @XmlElement(name = "TimeTableSubjectRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    @XmlElementRef(name = "TimeTableLocalId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "TeachingGroupLocalId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElement(name = "CellType", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
