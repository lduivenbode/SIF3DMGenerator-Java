 ...
 *       &lt;sequence>
 *         &lt;element name="CalendarDate" type="{http://www.sifassociation.org/au/datamodel/1.4}CalendarDateType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CalendarDateCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "calendarDate"
})
public class CalendarDateCollectionType {

    @XmlElement(name = "CalendarDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
