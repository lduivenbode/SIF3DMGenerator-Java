 ...
 *       &lt;sequence>
 *         &lt;element name="CalendarSummary" type="{http://www.sifassociation.org/au/datamodel/1.4}CalendarSummaryType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CalendarSummaryCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "calendarSummary"
})
public class CalendarSummaryCollectionType {

    @XmlElement(name = "CalendarSummary", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
