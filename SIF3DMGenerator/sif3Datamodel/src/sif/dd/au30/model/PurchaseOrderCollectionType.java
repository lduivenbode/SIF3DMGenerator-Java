 ...
 *       &lt;sequence>
 *         &lt;element name="PurchaseOrder" type="{http://www.sifassociation.org/au/datamodel/1.4}PurchaseOrderType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PurchaseOrderCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "purchaseOrder"
})
public class PurchaseOrderCollectionType {

    @XmlElement(name = "PurchaseOrder", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
