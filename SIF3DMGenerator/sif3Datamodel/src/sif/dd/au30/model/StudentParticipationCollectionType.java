 ...
 *       &lt;sequence>
 *         &lt;element name="StudentParticipation" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentParticipationType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentParticipationCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentParticipation"
})
public class StudentParticipationCollectionType {

    @XmlElement(name = "StudentParticipation", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
