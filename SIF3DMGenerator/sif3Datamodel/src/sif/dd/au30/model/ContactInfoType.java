...
@XmlType(name = "ContactInfoType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "name",
    "positionTitle",
    "role",
    "address",
...
public class ContactInfoType {
    ...
    @XmlElementRef(name = "PositionTitle", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
