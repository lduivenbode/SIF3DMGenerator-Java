 ...
 *       &lt;sequence>
 *         &lt;element name="TeachingGroup" type="{http://www.sifassociation.org/au/datamodel/1.4}TeachingGroupType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TeachingGroupCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "teachingGroup"
})
public class TeachingGroupCollectionType {

    @XmlElement(name = "TeachingGroup", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
