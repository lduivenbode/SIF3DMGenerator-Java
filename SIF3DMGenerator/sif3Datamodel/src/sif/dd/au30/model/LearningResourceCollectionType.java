 ...
 *       &lt;sequence>
 *         &lt;element name="LearningResource" type="{http://www.sifassociation.org/au/datamodel/1.4}LearningResourceType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LearningResourceCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "learningResource"
})
public class LearningResourceCollectionType {

    @XmlElement(name = "LearningResource", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
