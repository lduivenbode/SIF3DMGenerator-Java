...
@XmlType(name = "AssessmentType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "name",
    "assessmentId",
...
public class AssessmentType {
    ...
    @XmlElementRef(name = "AssessmentId", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
