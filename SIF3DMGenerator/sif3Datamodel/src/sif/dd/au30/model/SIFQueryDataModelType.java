 ...
 *             &lt;/complexType>
 *           &lt;/element>
 *           &lt;element name="SIF_Example" type="{http://www.sifassociation.org/au/datamodel/1.4}ObjectType" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
@XmlType(name = "SIF_QueryDataModelType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "sifQueryObject",
    "sifConditionGroup",
    "sifExample"
})
public class SIFQueryDataModelType {
    ...
    @XmlElement(name = "SIF_QueryObject", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected SIFQueryDataModelType.SIFQueryObject sifQueryObject;
    @XmlElementRef(name = "SIF_ConditionGroup", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<SIFQueryDataModelType.SIFConditionGroup> sifConditionGroup;
    @XmlElementRef(name = "SIF_Example", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
