...
@XmlType(name = "CalendarSummaryType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "schoolInfoRefId",
    "schoolYear",
    "localId",
    "description",
...
public class CalendarSummaryType {
    ...
    @XmlElement(name = "DaysInSession", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    @XmlElementRef(name = "FirstInstructionDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> firstInstructionDate;
    @XmlElementRef(name = "LastInstructionDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> lastInstructionDate;
    ...
    @XmlElementRef(name = "MinutesPerDay", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> minutesPerDay;
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getFirstInstructionDate() {
     ...
     *     
     */
    public void setFirstInstructionDate(JAXBElement<XMLGregorianCalendar> value) {
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getLastInstructionDate() {
     ...
     *     
     */
    public void setLastInstructionDate(JAXBElement<XMLGregorianCalendar> value) {
     ...
     *     
     */
    public JAXBElement<Long> getMinutesPerDay() {
     ...
     *     
     */
    public void setMinutesPerDay(JAXBElement<Long> value) {
