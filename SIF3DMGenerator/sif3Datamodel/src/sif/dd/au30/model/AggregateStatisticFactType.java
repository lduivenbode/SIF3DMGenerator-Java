 ...
 * 
 * <pre>
 * &lt;complexType name="AggregateStatisticFactType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="AggregateStatisticInfoRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="Characteristics" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="AggregateCharacteristicInfoRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "AggregateStatisticFactType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
...
public class AggregateStatisticFactType {
    ...
    @XmlElement(name = "AggregateStatisticInfoRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String aggregateStatisticInfoRefId;
    @XmlElement(name = "Characteristics", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected AggregateStatisticFactType.Characteristics characteristics;
    @XmlElementRef(name = "Excluded", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> excluded;
    @XmlElement(name = "Value", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
     ...
     *     
     */
    public JAXBElement<String> getExcluded() {
        return excluded;
    }
     ...
     *     
     */
    public void setExcluded(JAXBElement<String> value) {
        this.excluded = value;
    }
    ...
    public static class Characteristics {
        ...
        @XmlElement(name = "AggregateCharacteristicInfoRefId", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
