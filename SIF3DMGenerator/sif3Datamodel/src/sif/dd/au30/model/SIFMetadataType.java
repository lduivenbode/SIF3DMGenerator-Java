 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="LifeCycle" type="{http://www.sifassociation.org/au/datamodel/1.4}LifeCycleType" minOccurs="0"/>
 *         &lt;element name="EducationFilter" type="{http://www.sifassociation.org/au/datamodel/1.4}EducationFilterType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SIF_MetadataType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "timeElements",
    "lifeCycle",
    "educationFilter"
})
public class SIFMetadataType {
    ...
    @XmlElementRef(name = "LifeCycle", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LifeCycleType> lifeCycle;
    @XmlElementRef(name = "EducationFilter", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
