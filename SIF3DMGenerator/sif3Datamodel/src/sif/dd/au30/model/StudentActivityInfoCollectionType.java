 ...
 *       &lt;sequence>
 *         &lt;element name="StudentActivityInfo" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentActivityInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentActivityInfoCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentActivityInfo"
})
public class StudentActivityInfoCollectionType {

    @XmlElement(name = "StudentActivityInfo", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
