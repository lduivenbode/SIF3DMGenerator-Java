 ...
 *       &lt;sequence>
 *         &lt;element name="StudentSDTN" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentSDTNType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentSDTNCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentSDTN"
})
public class StudentSDTNCollectionType {

    @XmlElement(name = "StudentSDTN", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
