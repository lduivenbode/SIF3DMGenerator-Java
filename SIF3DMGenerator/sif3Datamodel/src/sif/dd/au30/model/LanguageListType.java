 ...
 *                   &lt;element name="LanguageType" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsLanguageTypeType" minOccurs="0"/>
...
@XmlType(name = "LanguageListType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "language"
})
public class LanguageListType {

    @XmlElement(name = "Language", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected List<LanguageListType.Language> language;
     ...
     * {@link LanguageListType.Language }
     * 
     * 
     */
    public List<LanguageListType.Language> getLanguage() {
        if (language == null) {
            language = new ArrayList<LanguageListType.Language>();
        }
    ...
    public static class Language {
        ...
        @XmlElementRef(name = "LanguageType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
        protected JAXBElement<String> languageType;
        @XmlElementRef(name = "Dialect", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
