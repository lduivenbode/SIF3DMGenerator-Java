...
@XmlType(name = "AssessmentSubTestType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "name",
    "scoreRange",
    "performanceLevels",
    "subjectArea",
...
public class AssessmentSubTestType {
    ...
    @XmlElementRef(name = "ScoreRange", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
