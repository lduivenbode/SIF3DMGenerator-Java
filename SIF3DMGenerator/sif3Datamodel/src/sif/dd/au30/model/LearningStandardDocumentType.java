 ...
 *         &lt;element name="RichDescription" type="{http://www.sifassociation.org/au/datamodel/1.4}AbstractContentElementType" minOccurs="0"/>
 ...
 *         &lt;element name="LearningStandardItemRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" minOccurs="0"/>
 *         &lt;element name="RelatedLearningStandards" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="LearningStandardDocumentRefId" type="{http://www.sifassociation.org/au/datamodel/1.4}IdRefType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "LearningStandardDocumentType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "title",
    "description",
    "richDescription",
    "source",
...
public class LearningStandardDocumentType {
    ...
    @XmlElement(name = "Title", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    ...
    @XmlElementRef(name = "RichDescription", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<AbstractContentElementType> richDescription;
    @XmlElement(name = "Source", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String source;
    @XmlElement(name = "Organizations", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected LearningStandardDocumentType.Organizations organizations;
    @XmlElementRef(name = "Authors", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<LearningStandardDocumentType.Authors> authors;
    @XmlElementRef(name = "OrganizationContactPoint", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> organizationContactPoint;
    @XmlElement(name = "SubjectAreas", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    protected LearningStandardDocumentType.SubjectAreas subjectAreas;
    @XmlElement(name = "DocumentStatus", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String documentStatus;
    @XmlElementRef(name = "DocumentDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> documentDate;
    @XmlElementRef(name = "LocalAdoptionDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> localAdoptionDate;
    @XmlElementRef(name = "LocalArchiveDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> localArchiveDate;
    @XmlElementRef(name = "EndOfLifeDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> endOfLifeDate;
    @XmlElementRef(name = "Copyright", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "RepositoryDate", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "RelatedLearningStandards", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    public static class Authors {
        ...
        @XmlElement(name = "Author", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
        @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
        @XmlSchemaType(name = "normalizedString")
    ...
    public static class Copyright {
        ...
        @XmlElementRef(name = "Holder", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
