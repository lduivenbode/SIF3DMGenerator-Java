 ...
 *         &lt;element name="DayValue" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsDayValueCodeType" minOccurs="0"/>
...
@XmlType(name = "StudentDailyAttendanceType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
...
public class StudentDailyAttendanceType {
    ...
    @XmlElementRef(name = "DayValue", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "AbsenceValue", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
