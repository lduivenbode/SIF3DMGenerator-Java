 ...
 *         &lt;element name="FamilyNameFirst" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
 *         &lt;element name="PreferredFamilyName" type="{http://www.w3.org/2001/XMLSchema}normalizedString" minOccurs="0"/>
 *         &lt;element name="PreferredFamilyNameFirst" type="{http://www.sifassociation.org/au/datamodel/1.4}AUCodeSetsYesOrNoCategoryType" minOccurs="0"/>
...
@XmlType(name = "BaseNameType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "title",
    "familyName",
    "givenName",
    "middleName",
...
public class BaseNameType {
    ...
    @XmlElementRef(name = "FamilyName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> familyName;
    @XmlElementRef(name = "GivenName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> givenName;
    @XmlElementRef(name = "MiddleName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> middleName;
    @XmlElementRef(name = "FamilyNameFirst", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> familyNameFirst;
    @XmlElementRef(name = "PreferredFamilyName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredFamilyName;
    @XmlElementRef(name = "PreferredFamilyNameFirst", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<AUCodeSetsYesOrNoCategoryType> preferredFamilyNameFirst;
    @XmlElementRef(name = "PreferredGivenName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredGivenName;
    @XmlElementRef(name = "Suffix", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<String> suffix;
    @XmlElementRef(name = "FullName", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
