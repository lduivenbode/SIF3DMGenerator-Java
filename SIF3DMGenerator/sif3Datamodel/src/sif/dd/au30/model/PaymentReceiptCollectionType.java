 ...
 *       &lt;sequence>
 *         &lt;element name="PaymentReceipt" type="{http://www.sifassociation.org/au/datamodel/1.4}PaymentReceiptType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PaymentReceiptCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "paymentReceipt"
})
public class PaymentReceiptCollectionType {

    @XmlElement(name = "PaymentReceipt", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
