 ...
 *       &lt;sequence>
 *         &lt;element name="StudentScoreSet" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentScoreSetType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentScoreSetCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentScoreSet"
})
public class StudentScoreSetCollectionType {

    @XmlElement(name = "StudentScoreSet", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
