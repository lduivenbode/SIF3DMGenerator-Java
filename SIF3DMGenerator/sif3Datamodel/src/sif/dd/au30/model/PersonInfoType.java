 ...
 *         &lt;element name="OtherNames" type="{http://www.sifassociation.org/au/datamodel/1.4}OtherNamesType" minOccurs="0"/>
 *         &lt;element name="Demographics" type="{http://www.sifassociation.org/au/datamodel/1.4}DemographicsType" minOccurs="0"/>
...
@XmlType(name = "PersonInfoType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "name",
    "otherNames",
    "demographics",
    "addressList",
...
public class PersonInfoType {
    ...
    @XmlElementRef(name = "OtherNames", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<OtherNamesType> otherNames;
    @XmlElementRef(name = "Demographics", namespace = "http://www.sifassociation.org/au/datamodel/1.4", type = JAXBElement.class, required = false)
