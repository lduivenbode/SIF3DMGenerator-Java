 ...
 *       &lt;sequence>
 *         &lt;element name="StudentActivityParticipation" type="{http://www.sifassociation.org/au/datamodel/1.4}StudentActivityParticipationType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StudentActivityParticipationCollectionType", namespace = "http://www.sifassociation.org/au/datamodel/1.4", propOrder = {
    "studentActivityParticipation"
})
public class StudentActivityParticipationCollectionType {

    @XmlElement(name = "StudentActivityParticipation", namespace = "http://www.sifassociation.org/au/datamodel/1.4")
